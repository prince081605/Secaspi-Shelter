...
class CareGuideSeeder extends Seeder
{
    public function run(): void
    {
        $guides = [
            ...
            // CAT GROOMING & HEALTH
            ['title' => 'Cat Grooming Essentials', 'species' => 'cat', 'category' => 'grooming', 'content' => 'Brushing needs depend on your cat\'s coat: long-haired cats benefit from daily brushing to prevent mats, while short-haired cats usually only need a weekly once-over to reduce shedding. Trim nails every 2-3 weeks. Clean ears monthly if they tend to build up wax. Brush teeth 2-3 times weekly for dental health. Keep grooming calm and positive with treats.'],
